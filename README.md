...
**AI 여행 일기 앱 — TravelDiary**
- 이미지와 표정 인식으로 감정을 선택하면 AI가 자동으로 여행 일기를 생성하는 모바일 앱
- React Native Expo, Zustand, TypeScript
- [GitHub 바로가기](https://github.com/seoho1025/TravelDiary)

**LCK 경기 사주 분석 서비스 — lck-fortune**
- LCK 경기 일정과 사주 분석을 결합한 웹 서비스
